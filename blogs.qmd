...
view: source
listing: 
  contents: blogs # this name must match the name of the folder you created in step #1; here, all Quarto docs in the `blogs` directory will be included on your listing page
